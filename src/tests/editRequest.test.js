...
const testEditRequest = () => {
  describe('User can edit open request', () => {
    ...
    it('should return 200 on an Empty update body .', (done) => {
      ...
      chai.request(app)
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.have.property('error').that.equals('Empty request body.');
          done();
        });
    });
    ...
    it('should return 200 on successful edit', (done) => {
      const path = `/api/v1/trips/edit/?requestId=${requestIdToEdit}`;
      chai.request(app)
        .patch(path)
        .send({
          origin: 'Kigali',
    ...
    it('returns 200 if the request rejected/closed ', (done) => {
      chai
        ...
        .end((error, res) => {
          ...
          expect(res.body).to.have.property('message').equals('The request successfully rejected');
          done();
        });
    });
