...
accommodationRouter.post('/create/accommodation', verifyToken.auth, isAdmin, accommodationValidataion, validateRooms, isExist, accommodation.createAccomodation);
